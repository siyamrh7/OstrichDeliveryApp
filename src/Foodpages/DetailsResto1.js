import styles from "./DetailsResto1.module.css";
      ...
      <div className={styles.backgroundDim}>
        <div className={styles.rectangleParent}>
          ...
          <div className={styles.paymentMethodWrapper}>
            <div className={styles.lorem}>Payment Method</div>
          </div>
          <img className={styles.dividerIcon2} alt="" src="/divider5.svg" />
          <div className={styles.frameParent14}>
            <div className={styles.itemInCartParent}>
              <div className={styles.back}>No Card</div>
              <div className={styles.frameParent15}>
                <div className={styles.iconlyregularlightdocumentContainer}>
                  <img
                    ...
                    src="/frame-303.svg"
                  />
                  <div className={styles.back}>My Wallet</div>
                </div>
            ...
            <div className={styles.itemInCartParent}>
              <div className={styles.creditCardWrapper}>
                <div className={styles.back}>Credit Card</div>
              </div>
                ...
                <div className={styles.yourOrder1}>
                  <div className={styles.iconlyregularlightdocumentContainer}>
                    ...
                    <div className={styles.creditCardParent}>
                      <div className={styles.back}>Credit Card</div>
                      <div className={styles.div5}>****1923</div>
                    </div>
                  </div>
            ...
            <div className={styles.itemInCartParent}>
              <div className={styles.deliverToParent}>
                <div className={styles.back}>Digital Payment</div>
              </div>
              <div className={styles.frameParent21}>
                  ...
                  <div className={styles.yourOrder1}>
                    <div className={styles.iconlyregularlightdocumentContainer}>
                      <img
                        ...
                        src="/frame-3032.svg"
                      />
                      <div className={styles.back}>Paypal</div>
                    </div>
                    <div className={styles.linkWrapper}>
                      <div className={styles.change}>Link</div>
                    </div>
                  </div>
                  <img
                ...
                <div className={styles.frameParent22}>
                  <div className={styles.yourOrder1}>
                    <div className={styles.iconlyregularlightdocumentContainer}>
                      <div className={styles.coin5Wrapper}>
                        <img
                      ...
                      <div className={styles.back}>MOX</div>
                    </div>
                    <div className={styles.linkWrapper}>
                      <div className={styles.change}>Link</div>
                    </div>
                  ...
                  <div className={styles.yourOrder1}>
                    <div className={styles.iconlyregularlightdocumentContainer}>
                      <img
                        ...
                        src="/frame-3033.svg"
                      />
                      <div className={styles.back}>Bitcoin</div>
                    </div>
                    <div className={styles.linkWrapper}>
                      <div className={styles.change}>Link</div>
                    </div>
        ...
        <div className={styles.navbarHome}>
          ...
          <div className={styles.navbarIcon1}>
            <img
              className={styles.iconlyregularoutlinearrow}
              alt=""
              src="/iconlyregularlightprofile1.svg"
            />
      ...
      <div className={styles.navbar1}>
        <div className={styles.yourOrder1}>
          <div className={styles.iconlycurvedboldshieldDoneParent}>
            ...
            />
            <div className={styles.cash}>Payment Method</div>
          </div>
        ...
        <div className={styles.payButton}>
          ...
          <div className={styles.payWrapper}>
            <div className={styles.back}>PAY</div>
          </div>
        </div>
      </div>
